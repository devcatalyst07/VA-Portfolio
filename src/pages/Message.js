...
function Form() {
  ...
  confirmAlert({
    ...
    // You can access the form input values using the state variables
  ...
  return (
    <div className="form-container">
      ...
      <div className="card3">
        <a href="https://www.instagram.com/dev_rjturingan_/" target="_blank" className="socialContainer containerOne">
        ...
        <a href="https://www.linkedin.com/in/roque-jerico-turingan-2346a8265/" target='_blank' className="socialContainer containerThree">
       ...
       <a href="https://www.facebook.com/dev.rjturingan/" target='_blank' className="socialContainer containerFour">
